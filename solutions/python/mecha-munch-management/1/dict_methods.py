...
def send_to_store(cart, aisle_mapping):
    ...
    sorted_aisle = dict(sorted(aisle_mapping.items()))
    
    fulfillment_cart = {}
    for items in reversed(sorted_cart):
      # get the value of items from the cart
      quantity = sorted_cart[items]
      #get the details of respective item from the aisle mapping
      details = aisle_mapping[items]
      details.insert(0, quantity)
      fulfillment_cart[items] =  details
